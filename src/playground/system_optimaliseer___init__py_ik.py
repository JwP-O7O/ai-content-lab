...
class ModuleInitializer:
    ...
    _registered_modules: List[
        Callable[[], Any]
    ] = []  # Changed from List[str] to List[Callable[[], Any]] - accepts a function that instantiates the module.
                ...
                try:
                    ...
                    for module_initializer in cls._registered_modules:
                        try:
                            ...
                            logging.error(
                                f"An unexpected error occurred during module initialization: {e}"
                            )
...
ModuleInitializer.register_module(
    initialize_my_module
)  # Register MyModule with its initializer function
