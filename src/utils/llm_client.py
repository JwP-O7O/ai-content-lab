...
class LLMClient:
    ...
    def __init__(self, generate_response="Mock generated content", create_response="Mock response"):
        self.generate_response = generate_response
        self.messages = self.Messages(create_response)
        logging.info(f"LLMClient initialized with generate_response: {self.generate_response} and create_response: {create_response}")
